...
class RecipeImageUploadTests(TestCase):
    ...
    def test_filter_recipes_by_tags(self):
        ...
        tag1 = sample_tag(user=self.user, name='TestTag1')
        tag2 = sample_tag(user=self.user, name='TestTag2')
    ...
    def test_filter_recipes_by_ingredients(self):
        ...
        recipe1 = sample_recipe(user=self.user, title='Test1')
        recipe2 = sample_recipe(user=self.user, title='Test2')
        ingredient1 = sample_ingredient(user=self.user, name='TestIngr1')
        ingredient2 = sample_ingredient(user=self.user, name='TestIngr2')
